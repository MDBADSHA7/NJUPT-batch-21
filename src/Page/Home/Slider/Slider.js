            ...
            <div className="px-12 lg:pb-16 py-10 pt-2  bg-base-100 border-b border-neutral hero-overlay bg-opacity-50">
                ...
                >
                    <SwiperSlide className="card mb-8 shadow-xl">
                        <Link to={'/course/english-for-career-development'}><img src="https://www.instagram.com/p/CQlK__Fnuoa/?hl=en" alt="image" /></Link>
                    </SwiperSlide>
                    <SwiperSlide className="card mb-8 shadow-xl">
                    ...
                    <SwiperSlide className="card mb-8 shadow-xl">
                        <Link to={'/course/freelancer-job'}><img src="https://www.instagram.com/p/CQlMZUYn7qb/?hl=en" alt="image" /></Link>
                    </SwiperSlide>
                </Swiper>
            </div>
        </div>
